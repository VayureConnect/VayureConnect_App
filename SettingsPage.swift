...
struct SettingsPage: View {
    ...
    // Persisted values
    @AppStorage("allowLocation") private var allowLocation = true
    @AppStorage("allowNotifications") private var allowNotifications = true
    
    @State private var showingAlert = false   // Alert state
        ...
        NavigationView {
            ...
            .alert(isPresented: $showingAlert) {
                Alert(
                    ...
                    message: Text("To disable location tracking, please go to Settings -> Apps -> VayureConnect -> Location and change the settings."),
...
//                Alert(
//                    title: Text("Location Disabled"),
//                    message: Text("Location access is required for the best experience. Please enable it in Settings."),
//                    dismissButton: .default(Text("OK"))
//                )
//            }
//        }
